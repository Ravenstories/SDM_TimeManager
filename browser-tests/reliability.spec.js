...
test("built app boots, saves a note, and preserves an active timer across reload", async ({ page }) => {
  const errors = [];
...
test("real IndexedDB serializes tabs and rolls back failed writes", async ({ page }) => {
  await page.goto("/");
